...
public:
  ...
  ///
  static void parseFileName(const String &path, String &folder,
  ...
  /// \return If file exist on the computer
  ///
  static bool isFileExist(const Path &path);
  ...
  /// \return If folder exists
  ///
  static bool isFolderExist(const Path &path);
  ...
  /// \return If folder exists
  ///
  static bool isFolderExist(const String &path);
  ...
  ///
  String relativePath(const String &relativeTo) const;
  ...
  /// \return The relative path
  ///
  static String relativePath(const Path &path, const String &relativeTo);
  ...
  /// C drive.
  ///
  static String absoluteFolder(const Path &path);
  ...
  ///
  static String toUnixFormat(const String &path);
  ...
  ///
  static String toWindowsFormat(const String &path);
