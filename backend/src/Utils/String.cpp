...
String::String(const char *text) : std::string(text) {}

String::String(const String &text) : std::string(text) {}

String::String(const std::basic_string<char> &text) : std::string(text) {}
...
String String::operator+(double val) { return *this + to_string(val); }

String String::operator+(size_t val) { return *this + std::to_string(val); }

String String::operator+(int val) { return *this + std::to_string(val); }

String String::operator()(size_t idx) const {
  if (idx >= this->length()) {
...
String String::operator()(size_t startIdx, size_t lastIdx) const {
  ...
  char *out =
      static_cast<char *>(malloc(lastIdx - startIdx + 2 * sizeof(char)));
...
String String::tolower() const { return tolower(*this); }
...
String String::toupper() const { return toupper(*this); }

String String::to_string(double val) {
...
String String::to_string(float val) {
  std::ostringstream out;
  out.precision(20);
  out << std::fixed << val;
  return removeTrailing(out.str(), "0");
...
String String::removeTrailing(const String &origin, const String &trailTag) {
