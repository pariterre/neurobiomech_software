...
TEST(Path, Create) {
  ...
  {
    EXPECT_STREQ(
        utils::Path::toUnixFormat("MyUgly\\\\WindowsPath\\\\ToMyFile.txt")
            .c_str(),
  ...
  {
    utils::String myPathInUglyWindowsStyleString(
        "MyUgly\\\\WindowsPath\\\\ToMyFile.txt");
  ...
  {
#ifdef _WIN32
    utils::String path("C:\\MyLovely\\AbsolutePath\\ToMyLovelyFile.txt");
    utils::String unixPath("C:/MyLovely/AbsolutePath/ToMyLovelyFile.txt");
    utils::String absoluteUnixFolder("C:/MyLovely/AbsolutePath/");
#else
    utils::String path("/MyLovely/AbsolutePath/ToMyLovelyFile.txt");
    utils::String unixPath("/MyLovely/AbsolutePath/ToMyLovelyFile.txt");
    ...
    EXPECT_STREQ(absolutePath.absoluteFolder().c_str(),
                 absoluteUnixFolder.c_str());
...

  {
    ...
    EXPECT_STREQ(
        ...
        (utils::Path::currentDir() + "MyLovely/RelativePath/ToMyLovelyFile.txt")
            .c_str());
    EXPECT_STREQ(
        relativePath.absoluteFolder().c_str(),
    ...
    EXPECT_STREQ(relativePath.relativePath().c_str(),
                 "./MyLovely/RelativePath/ToMyLovelyFile.txt");
    EXPECT_STREQ(relativePath.originalPath().c_str(),
                 "MyLovely/RelativePath/ToMyLovelyFile.txt");
  }

  {
    utils::Path weirdRelativePath("./MyLovely/RelativePath/ToMyLovelyFile.txt");
    EXPECT_STREQ(
        weirdRelativePath.absolutePath().c_str(),
        (utils::Path::currentDir() + "MyLovely/RelativePath/ToMyLovelyFile.txt")
            .c_str());
    EXPECT_STREQ(
        weirdRelativePath.absoluteFolder().c_str(),
        (utils::Path::currentDir() + "MyLovely/RelativePath/").c_str());
  ...
  {
    utils::Path parentRelativePath("../MyLovely/ParentPath/ToMyLovelyFile.txt");
    EXPECT_STREQ(parentRelativePath.absolutePath().c_str(),
                 (utils::Path::currentDir() +
                  "../MyLovely/ParentPath/ToMyLovelyFile.txt")
                     .c_str());
    EXPECT_STREQ(
...

  {
    ...
    EXPECT_STREQ(noPath.absolutePath().c_str(),
                 (utils::Path::currentDir() + "MyLonelyFile.txt").c_str());
...

  {
    ...
    EXPECT_STREQ(
        almostNoPath.absolutePath().c_str(),
        (utils::Path::currentDir() + "MyKinbDofLonelyFile.txt").c_str());
